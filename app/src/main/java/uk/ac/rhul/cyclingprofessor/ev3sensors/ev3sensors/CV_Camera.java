...
class CV_Camera implements CvCameraViewListener2 {
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        Scalar mBlobColorHsv = new Scalar(280.0 / 2, 0.65 * 255, 0.75 * 255, 255);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        if( center != null ) {
            ...
            double direction = (center.x - mRgba.cols() / 2.0) / mRgba.cols(); // portrait orientation
        }
        /*
        Flip image
    ...
    private String zxing() throws ChecksumException, FormatException {
        ...
        try {
            ...
            Imgproc.putText(mRgba, sResult,
                    new org.opencv.core.Point(mRgba.cols() / 4.0, mRgba.rows() / 2.0),
                    Imgproc.FONT_HERSHEY_COMPLEX, 1, TEXT_COLOR);
